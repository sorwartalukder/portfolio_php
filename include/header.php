...
<nav class="navbar">
    ...
    <a href="http://localhost/portfolio/dashboard">dashboard</a>
    <a href="http://localhost/portfolio/login.php">Login</a>
    <a href="http://localhost/portfolio/registration">Register</a>
</nav>